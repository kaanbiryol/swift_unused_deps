...
| `//cases/Targets/UnusedDepIOSTarget:UnusedDepIOSTarget` | Reports `unused_dep` for `LibA` under an iOS platform | Bats asserts iOS report metadata and verifies fix/apply removes the unused BUILD dep with `--build-config swift-unused-deps-ios` |
